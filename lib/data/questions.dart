...
// list of all the questions an their answers stored seperately,
// and then accessed accordingly...

var questions = [
  // internally we will always make sure that the correct
  // answer is the first option,
  // but we will shuffl the options before displaying on the screen.
